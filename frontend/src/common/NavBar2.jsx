            ...
            <Link to={logo.url}>
              <div className="flex items-center gap-2">
                <img
                  ...
                  alt={logo.alt}
                />
                <span className="text-lg font-semibold tracking-tighter dark:text-accent-foreground">
                  {logo.title}
                </span>
              </div>
            </Link>
  ...
  if (item.items) {
    return (
      <NavigationMenuItem key={item.title}>
        <NavigationMenuTrigger className="dark:text-accent-foreground">
          {item.title}
        </NavigationMenuTrigger>
        <NavigationMenuContent className="bg-popover text-popover-foreground dark:text-accent-foreground ">
...
const SubMenuLink = ({ item }) => {
  return (
    <a
      className="hover:bg-muted dark:text-accent-foreground hover:text-accent-foreground flex min-w-80 select-none flex-row gap-4 rounded-md p-3 leading-none no-underline outline-none transition-colors"
      href={item.url}
    >
